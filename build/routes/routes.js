...
const candidat_controller_1 = require("../controllers/candidat.controller");
const conge_controller_1 = require("../controllers/conge.controller");
const contrat_controller_1 = require("../controllers/contrat.controller");
const demande_controller_1 = require("../controllers/demande.controller");
const departement_controller_1 = require("../controllers/departement.controller");
const etat_civil_controller_1 = require("../controllers/etat_civil.controller");
const etudes_faites_controller_1 = require("../controllers/etudes_faites.controller");
const experience_professionnelle_controller_1 = require("../controllers/experience_professionnelle.controller");
const fiche_paie_controller_1 = require("../controllers/fiche_paie.controller");
const genre_controller_1 = require("../controllers/genre.controller");
const langue_controller_1 = require("../controllers/langue.controller");
const niveau_etude_controller_1 = require("../controllers/niveau_etude.controller");
const note_frais_controller_1 = require("../controllers/note_frais.controller");
const pays_controller_1 = require("../controllers/pays.controller");
const poste_controller_1 = require("../controllers/poste.controller");
const presence_controller_1 = require("../controllers/presence.controller");
const recrutement_controller_1 = require("../controllers/recrutement.controller");
const role_controller_1 = require("../controllers/role.controller");
const status_controller_1 = require("../controllers/status.controller");
const type_access_controller_1 = require("../controllers/type_access.controller");
const type_conge_controller_1 = require("../controllers/type_conge.controller");
const type_contrat_controller_1 = require("../controllers/type_contrat.controller");
const type_demande_controller_1 = require("../controllers/type_demande.controller");
const type_tache_controller_1 = require("../controllers/type_tache.controller");
 ...
 *
 */
router.post("/api/genre", auth_middleware_1.AuthMiddleware, genre_controller_1.AddGenre);
/**
 * @swagger
 * /api/genre:
 *  get:
 ...
 */
router.get("/api/genre", auth_middleware_1.AuthMiddleware, genre_controller_1.GetGenres);
/**
 * @swagger
 * /api/genre/{id}:
 *  get:
 ...
 *              $ref: '#/components/schemas/GenreNotFound'
 */
router.get("/api/genre/:id", auth_middleware_1.AuthMiddleware, genre_controller_1.GetGenreById);
/**
* @swagger
* /api/genre/{id}:
*  put:
...
*
*/
router.put("/api/genre/:id", auth_middleware_1.AuthMiddleware, genre_controller_1.UpdateGenre);
/**
 * @swagger
 * /api/genre/{id}:
 *  delete:
 ...
 *
 */
router.delete("/api/genre/:id", auth_middleware_1.AuthMiddleware, genre_controller_1.DeleteGenre);
// =============================== FIN ROUTES GENRE ===============================
// =============================== DEBUT ROUTES STATUT ============================
// statut routes
/**
 ...
 *
 */
router.post("/api/statut", auth_middleware_1.AuthMiddleware, status_controller_1.AddStatut);
/**
 * @swagger
 * /api/statut:
 *  get:
 ...
 */
router.get("/api/statut", auth_middleware_1.AuthMiddleware, status_controller_1.GetStatuts);
/**
 * @swagger
 * /api/statut/{id}:
 *  get:
 ...
 *              $ref: '#/components/schemas/StatutNotFound'
*/
router.get("/api/statut/:id", auth_middleware_1.AuthMiddleware, status_controller_1.GetStatutById);
/**
 * @swagger
 * /api/statut/{id}:
 *  put:
 ...
 *
*/
router.put("/api/statut/:id", auth_middleware_1.AuthMiddleware, status_controller_1.UpdateStatut);
/**
 * @swagger
 * /api/statut/{id}:
 *  delete:
 ...
 *
 */
router.delete("/api/statut/:id", auth_middleware_1.AuthMiddleware, status_controller_1.DeleteStatut);
// ========================== END Status Routes =========================
 ...
 *
 */
router.post("/api/niveau-etude", auth_middleware_1.AuthMiddleware, niveau_etude_controller_1.AddNiveauEtude);
/**
 * @swagger
 * /api/niveau-etude:
 *  get:
 ...
 */
router.get("/api/niveau-etude", auth_middleware_1.AuthMiddleware, niveau_etude_controller_1.GetNiveauEtudes);
/**
 * @swagger
 * /api/niveau-etude/{id}:
 *  get:
 ...
 *              $ref: '#/components/schemas/NiveauEtudeNotFound'
 */
router.get("/api/niveau-etude/:id", auth_middleware_1.AuthMiddleware, niveau_etude_controller_1.GetNiveauById);
/**
* @swagger
* /api/niveau-etude/{id}:
*  put:
...
*
*/
router.put("/api/niveau-etude/:id", auth_middleware_1.AuthMiddleware, niveau_etude_controller_1.UpdateNiveauEtude);
/**
 * @swagger
 * /api/niveau-etude/{id}:
 *  delete:
 ...
 *
 */
router.delete("/api/niveau-etude/:id", auth_middleware_1.AuthMiddleware, niveau_etude_controller_1.DeleteNiveauEtude);
 ...
 *
 */
router.post("/api/etat-civil", auth_middleware_1.AuthMiddleware, etat_civil_controller_1.AddEtatCivil);
/**
 * @swagger
 * /api/etat-civil:
 *  get:
 ...
 */
router.get("/api/etat-civil", auth_middleware_1.AuthMiddleware, etat_civil_controller_1.GetEtatCivils);
/**
 * @swagger
 * /api/etat-civil/{id}:
 *  get:
 ...
 *              $ref: '#/components/schemas/EtatCivilNotFound'
 */
router.get("/api/etat-civil/:id", auth_middleware_1.AuthMiddleware, etat_civil_controller_1.GetEtatCivilById);
/**
* @swagger
* /api/etat-civil/{id}:
*  put:
...
*
*/
router.put("/api/etat-civil/:id", auth_middleware_1.AuthMiddleware, etat_civil_controller_1.UpdateEtatCivil);
/**
 * @swagger
 * /api/etat-civil/{id}:
 *  delete:
 ...
 *
 */
router.delete("/api/etat-civil/:id", auth_middleware_1.AuthMiddleware, etat_civil_controller_1.DeleteEtatCivil);
 ...
 *
 */
router.post("/api/type-tache", auth_middleware_1.AuthMiddleware, type_tache_controller_1.AddTypeTache);
/**
 * @swagger
 * /api/type-tache:
 *  get:
 ...
 */
router.get("/api/type-tache", auth_middleware_1.AuthMiddleware, type_tache_controller_1.GetTypeTaches);
/**
 * @swagger
 * /api/type-tache/{id}:
 *  get:
 ...
 *              $ref: '#/components/schemas/TypeTacheNotFound'
 */
router.get("/api/type-tache/:id", auth_middleware_1.AuthMiddleware, type_tache_controller_1.GetTypeTacheById);
/**
* @swagger
* /api/type-tache/{id}:
*  put:
...
*
*/
router.put("/api/type-tache/:id", auth_middleware_1.AuthMiddleware, type_tache_controller_1.UpdateTypeTache);
/**
 * @swagger
 * /api/type-tache/{id}:
 *  delete:
 ...
 *
 */
router.delete("/api/type-tache/:id", auth_middleware_1.AuthMiddleware, type_tache_controller_1.DeleteTypeTache);
 ...
 *
 */
router.post("/api/type-access", auth_middleware_1.AuthMiddleware, type_access_controller_1.AddTypeAccess);
/**
 * @swagger
 * /api/type-access:
 *  get:
 ...
 */
router.get("/api/type-access", auth_middleware_1.AuthMiddleware, type_access_controller_1.GetTypeAccess);
/**
 * @swagger
 * /api/type-access/{id}:
 *  get:
 ...
 *              $ref: '#/components/schemas/TypeAccessNotFound'
 */
router.get("/api/type-access/:id", auth_middleware_1.AuthMiddleware, type_access_controller_1.GetTypeAccessById);
/**
* @swagger
* /api/type-access/{id}:
*  put:
...
*
*/
router.put("/api/type-access/:id", auth_middleware_1.AuthMiddleware, type_access_controller_1.UpdateTypeAccess);
/**
 * @swagger
 * /api/type-access/{id}:
 *  delete:
 ...
 *
 */
router.delete("/api/type-access/:id", auth_middleware_1.AuthMiddleware, type_access_controller_1.DeleteTypeAccess);
 ...
 *
 */
router.post("/api/type-conge", auth_middleware_1.AuthMiddleware, type_conge_controller_1.AddTypeConge);
/**
 * @swagger
 * /api/type-conge:
 *  get:
 ...
 */
router.get("/api/type-conge", auth_middleware_1.AuthMiddleware, type_conge_controller_1.GetTypeConges);
/**
 * @swagger
 * /api/type-conge/{id}:
 *  get:
 ...
 *              $ref: '#/components/schemas/TypeCongeNotFound'
 */
router.get("/api/type-conge/:id", auth_middleware_1.AuthMiddleware, type_conge_controller_1.GetTypeCongeById);
/**
* @swagger
* /api/type-conge/{id}:
*  put:
...
*
*/
router.put("/api/type-conge/:id", auth_middleware_1.AuthMiddleware, type_conge_controller_1.UpdateTypeConge);
/**
 * @swagger
 * /api/type-conge/{id}:
 *  delete:
 ...
 *
 */
router.delete("/api/type-conge/:id", auth_middleware_1.AuthMiddleware, type_conge_controller_1.DeleteTypeConge);
 ...
 *
 */
router.post("/api/type-contrat", auth_middleware_1.AuthMiddleware, type_contrat_controller_1.AddTypeContrat);
/**
 * @swagger
 * /api/type-contrat:
 *  get:
 ...
 */
router.get("/api/type-contrat", auth_middleware_1.AuthMiddleware, type_contrat_controller_1.GetTypeContrats);
/**
 * @swagger
 * /api/type-contrat/{id}:
 *  get:
 ...
 *              $ref: '#/components/schemas/TypeContratNotFound'
 */
router.get("/api/type-contrat/:id", auth_middleware_1.AuthMiddleware, type_contrat_controller_1.GetTypeContratById);
/**
* @swagger
* /api/type-contrat/{id}:
*  put:
...
*
*/
router.put("/api/type-contrat/:id", auth_middleware_1.AuthMiddleware, type_contrat_controller_1.UpdateTypeContrat);
/**
 * @swagger
 * /api/type-contrat/{id}:
 *  delete:
 ...
 *
 */
router.delete("/api/type-contrat/:id", auth_middleware_1.AuthMiddleware, type_contrat_controller_1.DeleteTypeContrat);
 ...
 *
 */
router.post("/api/type-demande", auth_middleware_1.AuthMiddleware, type_demande_controller_1.AddTypeDemande);
/**
 * @swagger
 * /api/type-demande:
 *  get:
 ...
 */
router.get("/api/type-demande", auth_middleware_1.AuthMiddleware, type_demande_controller_1.GetTypeDemandes);
/**
 * @swagger
 * /api/type-demande/{id}:
 *  get:
 ...
 *              $ref: '#/components/schemas/TypeDemandeNotFound'
 */
router.get("/api/type-demande/:id", auth_middleware_1.AuthMiddleware, type_demande_controller_1.GetTypeDemandeById);
/**
* @swagger
* /api/type-demande/{id}:
*  put:
...
*
*/
router.put("/api/type-demande/:id", auth_middleware_1.AuthMiddleware, type_demande_controller_1.UpdateTypeDemande);
/**
 * @swagger
 * /api/type-demande/{id}:
 *  delete:
 ...
 *
 */
router.delete("/api/type-demande/:id", auth_middleware_1.AuthMiddleware, type_demande_controller_1.DeleteTypeDemande);
// =============================== FIN ROUTES TYPE DEMANDE =============================
// =============================== DEBUT ROUTES Pays =========================
// pays routes
router.post("/api/pays", pays_controller_1.AddPays);
// ======================== END Pays routes ===================================
// ================================= DEBUT ROUTES ACCESS =======================
/**
 * @swagger
 ...
 *
 */
router.post("/api/access", auth_middleware_1.AuthMiddleware, access_controller_1.AddAccess);
/**
 * @swagger
 * /api/access:
 *  get:
 ...
 */
router.get("/api/access", auth_middleware_1.AuthMiddleware, access_controller_1.GetAccess);
/**
* @swagger
* /api/access/{id}:
*  get:
...
*              $ref: '#/components/schemas/AccessNotFound'
*/
router.get("/api/access/:id", auth_middleware_1.AuthMiddleware, access_controller_1.GetAccessById);
/**
 * @swagger
 * /api/access/{id}:
 *  put:
 ...
 *
 */
router.put("/api/access/:id", auth_middleware_1.AuthMiddleware, access_controller_1.UpdateAccess);
/**
* @swagger
* /api/access/{id}:
*  delete:
...
*
*/
router.delete("/api/access/:id", auth_middleware_1.AuthMiddleware, access_controller_1.DeleteAccess);
// ================================= FIN ROUTES ACCESS =========================
 ...
 *
 */
router.post("/api/experience-professionnelle", auth_middleware_1.AuthMiddleware, experience_professionnelle_controller_1.AddExperience);
/**
 * @swagger
 * /api/experience-professionnelle:
 *  get:
 ...
 */
router.get("/api/experience-professionnelle", auth_middleware_1.AuthMiddleware, experience_professionnelle_controller_1.GetExperiences);
/**
* @swagger
...
*              $ref: '#/components/schemas/ExperienceNotFound'
*/
router.get("/api/experience-professionnelle/:id", auth_middleware_1.AuthMiddleware, experience_professionnelle_controller_1.GetExperienceById);
/**
 * @swagger
 * /api/experience-professionnelle/{id}:
 *  put:
 ...
 *
 */
router.put("/api/experience-professionnelle/:id", auth_middleware_1.AuthMiddleware, experience_professionnelle_controller_1.UpdateExperience);
/**
* @swagger
* /api/experience-professionnelle/{id}:
*  delete:
...
*
*/
router.delete("/api/experience-professionnelle/:id", auth_middleware_1.AuthMiddleware, experience_professionnelle_controller_1.DeleteExperience);
 ...
 *
 */
router.post("/api/etude-faites", auth_middleware_1.AuthMiddleware, etudes_faites_controller_1.AddEtudeFaites);
/**
 * @swagger
 * /api/etude-faites:
 *  get:
 ...
 */
router.get("/api/etude-faites", auth_middleware_1.AuthMiddleware, etudes_faites_controller_1.GetEtudeFaites);
/**
* @swagger
* /api/etude-faites/{id}:
*  get:
...
*              $ref: '#/components/schemas/EtudeFaitesNotFound'
*/
router.get("/api/etude-faites/:id", auth_middleware_1.AuthMiddleware, etudes_faites_controller_1.GetEtudeFaitesById);
/**
 * @swagger
 * /api/etude-faites/{id}:
 *  put:
 ...
 *
 */
router.put("/api/etude-faites/:id", auth_middleware_1.AuthMiddleware, etudes_faites_controller_1.UpdateEtudeFaites);
/**
* @swagger
* /api/etude-faites/{id}:
*  delete:
...
*
*/
router.delete("/api/etude-faites/:id", auth_middleware_1.AuthMiddleware, etudes_faites_controller_1.DeleteEtudeFaites);
 ...
 *
 */
router.post("/api/departement", auth_middleware_1.AuthMiddleware, departement_controller_1.AddDepartement);
/**
 * @swagger
 * /api/departement:
 *  get:
 ...
 */
router.get("/api/departement", auth_middleware_1.AuthMiddleware, departement_controller_1.GetDepartements);
/**
* @swagger
* /api/departement/{id}:
*  get:
...
*              $ref: '#/components/schemas/DepartementNotFound'
*/
router.get("/api/departement/:id", auth_middleware_1.AuthMiddleware, departement_controller_1.GetDepartementById);
/**
 * @swagger
 * /api/departement/{id}:
 *  put:
 ...
 *
 */
router.put("/api/departement/:id", auth_middleware_1.AuthMiddleware, departement_controller_1.UpdateDepartement);
/**
* @swagger
* /api/departement/{id}:
*  delete:
...
*
*/
router.delete("/api/departement/:id", auth_middleware_1.AuthMiddleware, departement_controller_1.DeleteDepartement);
 ...
 *
 */
router.post("/api/poste", auth_middleware_1.AuthMiddleware, poste_controller_1.AddPoste);
/**
 * @swagger
 * /api/poste:
 *  get:
 ...
 */
router.get("/api/poste", auth_middleware_1.AuthMiddleware, poste_controller_1.GetPostes);
/**
* @swagger
* /api/poste/{id}:
*  get:
...
*              $ref: '#/components/schemas/PosteNotFound'
*/
router.get("/api/poste/:id", auth_middleware_1.AuthMiddleware, poste_controller_1.GetPosteById);
/**
 * @swagger
 * /api/poste/{id}:
 *  put:
 ...
 *
 */
router.put("/api/poste/:id", auth_middleware_1.AuthMiddleware, poste_controller_1.UpdatePoste);
/**
* @swagger
* /api/poste/{id}:
*  delete:
...
*
*/
router.delete("/api/poste/:id", auth_middleware_1.AuthMiddleware, poste_controller_1.DeletePoste);
// ================================= FIN ROUTES POSTE =========================
// ================================= DEBUT ROUTES ROLE =======================
/**
 * @swagger
 ...
 *
 */
router.post("/api/role", auth_middleware_1.AuthMiddleware, role_controller_1.AddRole);
/**
 * @swagger
 * /api/role:
 *  get:
 ...
 */
router.get("/api/role", auth_middleware_1.AuthMiddleware, role_controller_1.GetRoles);
/**
* @swagger
* /api/role/{id}:
*  get:
...
*              $ref: '#/components/schemas/RoleNotFound'
*/
router.get("/api/role/:id", auth_middleware_1.AuthMiddleware, role_controller_1.GetRoleById);
/**
 * @swagger
 * /api/role/{id}:
 *  put:
 ...
 *
 */
router.put("/api/role/:id", auth_middleware_1.AuthMiddleware, role_controller_1.UpdateRole);
/**
* @swagger
* /api/role/{id}:
*  delete:
...
*
*/
router.delete("/api/role/:id", auth_middleware_1.AuthMiddleware, role_controller_1.DeleteRole);
// ================================= FIN ROUTES ROLE =========================
// ================================= DEBUT ROUTES AGENT =======================
/**
 * @swagger
 ...
 *
 */
router.post("/api/agent", auth_middleware_1.AuthMiddleware, agent_controller_1.AddAgent);
/**
 * @swagger
 * /api/agent:
 *  get:
 ...
 */
router.get("/api/agent", auth_middleware_1.AuthMiddleware, agent_controller_1.GetAgents);
/**
* @swagger
* /api/agent/{id}:
*  get:
...
*              $ref: '#/components/schemas/AgentNotFound'
*/
router.get("/api/agent/:id", auth_middleware_1.AuthMiddleware, agent_controller_1.GetAgentById);
/**
 * @swagger
 * /api/agent/{id}:
 *  put:
 ...
 *
 */
router.put("/api/agent/:id", auth_middleware_1.AuthMiddleware, agent_controller_1.UpdateAgent);
/**
* @swagger
* /api/agent/{id}:
*  delete:
...
*
*/
router.delete("/api/agent/:id", auth_middleware_1.AuthMiddleware, agent_controller_1.DeleteAgent);
// ================================= FIN ROUTES AGENT =========================
 ...
 *
 */
router.post("/api/demande", auth_middleware_1.AuthMiddleware, demande_controller_1.AddDemande);
/**
 * @swagger
 * /api/demande:
 *  get:
 ...
 */
router.get("/api/demande", auth_middleware_1.AuthMiddleware, demande_controller_1.GetDemandes);
/**
* @swagger
* /api/demande/{id}:
*  get:
...
*              $ref: '#/components/schemas/DemandeNotFound'
*/
router.get("/api/demande/:id", auth_middleware_1.AuthMiddleware, demande_controller_1.GetDemandeById);
/**
 * @swagger
 * /api/demande/{id}:
 *  put:
 ...
 *
 */
router.put("/api/demande/:id", auth_middleware_1.AuthMiddleware, demande_controller_1.UpdateDemande);
/**
* @swagger
* /api/demande/{id}:
*  delete:
...
*
*/
router.delete("/api/demande/:id", auth_middleware_1.AuthMiddleware, demande_controller_1.DeleteDemande);
// ================================= FIN ROUTES DEMANDE =========================
 ...
 *
 */
router.post("/api/note-frais", auth_middleware_1.AuthMiddleware, note_frais_controller_1.AddNoteFrais);
/**
 * @swagger
 * /api/note-frais:
 *  get:
 ...
 */
router.get("/api/note-frais", auth_middleware_1.AuthMiddleware, note_frais_controller_1.GetNoteFrais);
/**
* @swagger
* /api/note-frais/{id}:
*  get:
...
*              $ref: '#/components/schemas/NoteFraisNotFound'
*/
router.get("/api/note-frais/:id", auth_middleware_1.AuthMiddleware, note_frais_controller_1.GetNoteFraisById);
/**
 * @swagger
 * /api/note-frais/{id}:
 *  put:
 ...
 *
 */
router.put("/api/note-frais/:id", auth_middleware_1.AuthMiddleware, note_frais_controller_1.UpdateNoteFrais);
/**
* @swagger
* /api/note-frais/{id}:
*  delete:
...
*
*/
router.delete("/api/note-frais/:id", auth_middleware_1.AuthMiddleware, note_frais_controller_1.DeleteNoteFrais);
 ...
 *
 */
router.post("/api/presence", auth_middleware_1.AuthMiddleware, presence_controller_1.AddPresence);
/**
 * @swagger
 * /api/presence:
 *  get:
 ...
 */
router.get("/api/presence", auth_middleware_1.AuthMiddleware, presence_controller_1.GetPresences);
/**
* @swagger
* /api/presence/{id}:
*  get:
...
*              $ref: '#/components/schemas/PresenceNotFound'
*/
router.get("/api/presence/:id", auth_middleware_1.AuthMiddleware, presence_controller_1.GetPresenceById);
/**
 * @swagger
 * /api/presence/{id}:
 *  put:
 ...
 *
 */
router.put("/api/presence/:id", auth_middleware_1.AuthMiddleware, presence_controller_1.UpdatePresence);
/**
* @swagger
* /api/presence/{id}:
*  delete:
...
*
*/
router.delete("/api/presence/:id", auth_middleware_1.AuthMiddleware, presence_controller_1.DeletePresence);
// ================================= FIN ROUTES PRESENCE =========================
 ...
 *
 */
router.post("/api/fiche-paie", auth_middleware_1.AuthMiddleware, fiche_paie_controller_1.AddFichePaie);
/**
 * @swagger
 * /api/fiche-paie:
 *  get:
 ...
 */
router.get("/api/fiche-paie", auth_middleware_1.AuthMiddleware, fiche_paie_controller_1.GetFichePaies);
/**
* @swagger
* /api/fiche-paie/{id}:
*  get:
...
*              $ref: '#/components/schemas/FichePaieNotFound'
*/
router.get("/api/fiche-paie/:id", auth_middleware_1.AuthMiddleware, fiche_paie_controller_1.GetFichePaieById);
/**
 * @swagger
 * /api/fiche-paie/{id}:
 *  put:
 ...
 *
 */
router.put("/api/fiche-paie/:id", auth_middleware_1.AuthMiddleware, fiche_paie_controller_1.UpdateFichePaie);
/**
* @swagger
* /api/fiche-paie/{id}:
*  delete:
...
*
*/
router.delete("/api/fiche-paie/:id", auth_middleware_1.AuthMiddleware, fiche_paie_controller_1.DeleteFichePaie);
 ...
 *
 */
router.post("/api/contrat", auth_middleware_1.AuthMiddleware, contrat_controller_1.AddContrat);
/**
 * @swagger
 * /api/contrat:
 *  get:
 ...
 */
router.get("/api/contrat", auth_middleware_1.AuthMiddleware, contrat_controller_1.GetContrats);
/**
* @swagger
* /api/contrat/{id}:
*  get:
...
*              $ref: '#/components/schemas/ContratNotFound'
*/
router.get("/api/contrat/:id", auth_middleware_1.AuthMiddleware, contrat_controller_1.GetContratById);
/**
 * @swagger
 * /api/contrat/{id}:
 *  put:
 ...
 *
 */
router.put("/api/contrat/:id", auth_middleware_1.AuthMiddleware, contrat_controller_1.UpdateContrat);
/**
* @swagger
* /api/contrat/{id}:
*  delete:
...
*
*/
router.delete("/api/contrat/:id", auth_middleware_1.AuthMiddleware, contrat_controller_1.DeleteContrat);
// ================================= FIN ROUTES CONTRAT =========================
// ================================= DEBUT ROUTES CONGE ==========================
/**
 * @swagger
 ...
 *
 */
router.post("/api/conge", auth_middleware_1.AuthMiddleware, conge_controller_1.AddConge);
/**
 * @swagger
 * /api/conge:
 *  get:
 ...
 */
router.get("/api/conge", auth_middleware_1.AuthMiddleware, conge_controller_1.GetConges);
/**
* @swagger
* /api/conge/{id}:
*  get:
...
*              $ref: '#/components/schemas/CongeNotFound'
*/
router.get("/api/conge/:id", auth_middleware_1.AuthMiddleware, conge_controller_1.GetCongeById);
/**
 * @swagger
 * /api/conge/{id}:
 *  put:
 ...
 *
 */
router.put("/api/conge/:id", auth_middleware_1.AuthMiddleware, conge_controller_1.UpdateConge);
/**
* @swagger
* /api/conge/{id}:
*  delete:
...
*
*/
router.delete("/api/conge/:id", auth_middleware_1.AuthMiddleware, conge_controller_1.DeleteConge);
// ================================= FIN ROUTES CONGE =========================
// ================================= DEBUT ROUTES LANGUE ==========================
/**
 * @swagger
 ...
 *
 */
router.post("/api/langue", auth_middleware_1.AuthMiddleware, langue_controller_1.AddLangue);
/**
 * @swagger
 * /api/langue:
 *  get:
 ...
 */
router.get("/api/langue", auth_middleware_1.AuthMiddleware, langue_controller_1.GetLangues);
/**
* @swagger
* /api/langue/{id}:
*  get:
...
*              $ref: '#/components/schemas/LangueNotFound'
*/
router.get("/api/langue/:id", auth_middleware_1.AuthMiddleware, langue_controller_1.GetLangueById);
/**
 * @swagger
 * /api/langue/{id}:
 *  put:
 ...
 *
 */
router.put("/api/langue/:id", auth_middleware_1.AuthMiddleware, langue_controller_1.UpdateLangue);
/**
* @swagger
* /api/langue/{id}:
*  delete:
...
*
*/
router.delete("/api/langue/:id", auth_middleware_1.AuthMiddleware, langue_controller_1.DeleteLangue);
// ================================= FIN ROUTES LANGUE =========================
 ...
 *
 */
router.post("/api/candidat", auth_middleware_1.AuthMiddleware, candidat_controller_1.AddCandidat);
/**
 * @swagger
 * /api/candidat:
 *  get:
 ...
 */
router.get("/api/candidat", auth_middleware_1.AuthMiddleware, candidat_controller_1.GetCandidats);
/**
* @swagger
* /api/candidat/{id}:
*  get:
...
*              $ref: '#/components/schemas/CandidatNotFound'
*/
router.get("/api/candidat/:id", auth_middleware_1.AuthMiddleware, candidat_controller_1.GetCandidatById);
/**
 * @swagger
 * /api/candidat/{id}:
 *  put:
 ...
 *
 */
router.put("/api/candidat/:id", auth_middleware_1.AuthMiddleware, candidat_controller_1.UpdateCandidat);
/**
* @swagger
* /api/candidat/{id}:
*  delete:
...
*
*/
router.delete("/api/candidat/:id", auth_middleware_1.AuthMiddleware, candidat_controller_1.DeleteCandidat);
// ================================= FIN ROUTES CANDIDAT =========================
 ...
 *
 */
router.post("/api/recrutement", auth_middleware_1.AuthMiddleware, recrutement_controller_1.AddRecrutement);
/**
 * @swagger
 * /api/recrutement:
 *  get:
 ...
 */
router.get("/api/recrutement", auth_middleware_1.AuthMiddleware, recrutement_controller_1.GetRecrutements);
/**
* @swagger
* /api/recrutement/{id}:
*  get:
...
*              $ref: '#/components/schemas/RecrutementNotFound'
*/
router.get("/api/recrutement/:id", auth_middleware_1.AuthMiddleware, recrutement_controller_1.GetRecrutementById);
/**
 * @swagger
 * /api/recrutement/{id}:
 *  put:
 ...
 *
 */
router.put("/api/recrutement/:id", auth_middleware_1.AuthMiddleware, recrutement_controller_1.UpdateRecrutement);
/**
* @swagger
* /api/recrutement/{id}:
*  delete:
...
*
*/
router.delete("/api/recrutement/:id", auth_middleware_1.AuthMiddleware, recrutement_controller_1.DeleteRecrutement);
 ...
 *
 */
router.post("/api/agent/login", auth_controller_1.Login);
/**
* @swagger
* /api/user:
*  get:
